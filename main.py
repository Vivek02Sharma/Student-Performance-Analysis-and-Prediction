...
from web_pages import home, dataset, analysis, prediction, about, dashboard, predict_student # import dashboard
...
def main_application():
    try:
        ...
        with st.sidebar:
            ...
            if st.session_state['user_type'] == "professor":
                ...
                bar = option_menu(
                    menu_title = "Menu",
                    menu_icon = "list",
                    options = ["Home", "My Dashboard", "Student Predict", "About"]
                )
        ...
        if bar == "Home":
            ...
            logging.info("Navigating to Student Prediction page.")
